...
import { EdgeAvgAggregateInputObjectSchema } from './objects/EdgeAvgAggregateInput.schema';
import { EdgeSumAggregateInputObjectSchema } from './objects/EdgeSumAggregateInput.schema';
...
export const EdgeAggregateSchema = z.object({
    ...
    _count: z.union([z.literal(true), EdgeCountAggregateInputObjectSchema]).optional(),
    _min: EdgeMinAggregateInputObjectSchema.optional(),
    _max: EdgeMaxAggregateInputObjectSchema.optional(),
    _avg: EdgeAvgAggregateInputObjectSchema.optional(),
    _sum: EdgeSumAggregateInputObjectSchema.optional(),
});
