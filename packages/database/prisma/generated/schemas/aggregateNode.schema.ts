...
import { NodeAvgAggregateInputObjectSchema } from './objects/NodeAvgAggregateInput.schema';
import { NodeSumAggregateInputObjectSchema } from './objects/NodeSumAggregateInput.schema';
...
export const NodeAggregateSchema = z.object({
    ...
    _count: z.union([z.literal(true), NodeCountAggregateInputObjectSchema]).optional(),
    _min: NodeMinAggregateInputObjectSchema.optional(),
    _max: NodeMaxAggregateInputObjectSchema.optional(),
    _avg: NodeAvgAggregateInputObjectSchema.optional(),
    _sum: NodeSumAggregateInputObjectSchema.optional(),
});
