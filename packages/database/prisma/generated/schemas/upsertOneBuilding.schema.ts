...
export const BuildingUpsertSchema = z.object({
    ...
    create: z.union([BuildingCreateInputObjectSchema, BuildingUncheckedCreateInputObjectSchema]),
    update: z.union([BuildingUpdateInputObjectSchema, BuildingUncheckedUpdateInputObjectSchema]),
});
