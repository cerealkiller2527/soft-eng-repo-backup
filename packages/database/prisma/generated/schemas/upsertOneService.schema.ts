...
export const ServiceUpsertSchema = z.object({
    ...
    create: z.union([ServiceCreateInputObjectSchema, ServiceUncheckedCreateInputObjectSchema]),
    update: z.union([ServiceUpdateInputObjectSchema, ServiceUncheckedUpdateInputObjectSchema]),
});
