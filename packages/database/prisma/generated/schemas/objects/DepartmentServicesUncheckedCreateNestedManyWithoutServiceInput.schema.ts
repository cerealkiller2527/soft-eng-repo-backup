...
const Schema: z.ZodType<Prisma.DepartmentServicesUncheckedCreateNestedManyWithoutServiceInput> = z
    .object({
        create: z
            .union([
...
export const DepartmentServicesUncheckedCreateNestedManyWithoutServiceInputObjectSchema = Schema;
