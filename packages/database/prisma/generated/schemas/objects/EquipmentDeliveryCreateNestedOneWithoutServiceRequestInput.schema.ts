...
const Schema: z.ZodType<Prisma.EquipmentDeliveryCreateNestedOneWithoutServiceRequestInput> = z
    .object({
        create: z
            .union([
...
export const EquipmentDeliveryCreateNestedOneWithoutServiceRequestInputObjectSchema = Schema;
