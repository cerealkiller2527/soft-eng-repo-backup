...
const Schema: z.ZodType<Prisma.LocationUncheckedCreateNestedManyWithoutNodeInput> = z
    .object({
        create: z
            .union([
...
export const LocationUncheckedCreateNestedManyWithoutNodeInputObjectSchema = Schema;
