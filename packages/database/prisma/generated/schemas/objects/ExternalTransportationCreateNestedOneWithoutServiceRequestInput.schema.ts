...
const Schema: z.ZodType<Prisma.ExternalTransportationCreateNestedOneWithoutServiceRequestInput> = z
    .object({
        create: z
            .union([
            ...
            .optional(),
        connectOrCreate: z
            .lazy(() => ExternalTransportationCreateOrConnectWithoutServiceRequestInputObjectSchema)
            .optional(),
        connect: z.lazy(() => ExternalTransportationWhereUniqueInputObjectSchema).optional(),
    })
    .strict();

export const ExternalTransportationCreateNestedOneWithoutServiceRequestInputObjectSchema = Schema;
