...
const Schema: z.ZodType<Prisma.ExternalTransportationOrderByWithRelationInput> = z
    .object({
...
export const ExternalTransportationOrderByWithRelationInputObjectSchema = Schema;
