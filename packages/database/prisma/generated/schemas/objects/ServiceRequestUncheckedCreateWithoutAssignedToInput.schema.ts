...
const Schema: z.ZodType<Prisma.ServiceRequestUncheckedCreateWithoutAssignedToInput> = z
    .object({
...
export const ServiceRequestUncheckedCreateWithoutAssignedToInputObjectSchema = Schema;
