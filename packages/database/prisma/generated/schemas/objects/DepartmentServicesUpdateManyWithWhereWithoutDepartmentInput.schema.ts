...
const Schema: z.ZodType<Prisma.DepartmentServicesUpdateManyWithWhereWithoutDepartmentInput> = z
    .object({
...
export const DepartmentServicesUpdateManyWithWhereWithoutDepartmentInputObjectSchema = Schema;
