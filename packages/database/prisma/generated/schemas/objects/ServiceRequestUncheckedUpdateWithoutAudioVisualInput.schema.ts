...
const Schema: z.ZodType<Prisma.ServiceRequestUncheckedUpdateWithoutAudioVisualInput> = z
    .object({
        id: z
...
export const ServiceRequestUncheckedUpdateWithoutAudioVisualInputObjectSchema = Schema;
