...
const Schema: z.ZodType<Prisma.ServiceRequestUncheckedUpdateWithoutLanguageInput> = z
    .object({
        id: z
...
export const ServiceRequestUncheckedUpdateWithoutLanguageInputObjectSchema = Schema;
