...
const Schema: z.ZodType<Prisma.ExternalTransportationUpdateOneWithoutServiceRequestNestedInput> = z
    .object({
        create: z
            .union([
...
export const ExternalTransportationUpdateOneWithoutServiceRequestNestedInputObjectSchema = Schema;
