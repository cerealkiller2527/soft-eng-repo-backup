...
const Schema: z.ZodType<Prisma.ExternalTransportationMaxOrderByAggregateInput> = z
    .object({
...
export const ExternalTransportationMaxOrderByAggregateInputObjectSchema = Schema;
