...
const Schema: z.ZodType<Prisma.ServiceRequestUncheckedCreateWithoutLanguageInput> = z
    .object({
...
export const ServiceRequestUncheckedCreateWithoutLanguageInputObjectSchema = Schema;
