...
const Schema: z.ZodType<Prisma.ServiceRequestCreateWithoutAudioVisualInput> = z
    .object({
...
export const ServiceRequestCreateWithoutAudioVisualInputObjectSchema = Schema;
