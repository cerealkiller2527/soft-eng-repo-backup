...
const Schema: z.ZodType<Prisma.ServiceRequestUncheckedCreateWithoutExternalTransportationInput> = z
    .object({
...
export const ServiceRequestUncheckedCreateWithoutExternalTransportationInputObjectSchema = Schema;
