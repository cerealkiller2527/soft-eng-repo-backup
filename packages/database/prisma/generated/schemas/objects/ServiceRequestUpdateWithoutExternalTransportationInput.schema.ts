...
import { EquipmentDeliveryUpdateOneWithoutServiceRequestNestedInputObjectSchema } from './EquipmentDeliveryUpdateOneWithoutServiceRequestNestedInput.schema';
...
const Schema: z.ZodType<Prisma.ServiceRequestUpdateWithoutExternalTransportationInput> = z
    .object({
        type: z
            .union([
        ...
        audioVisual: z
            ...
            .optional(),
        equipmentDelivery: z
            .lazy(() => EquipmentDeliveryUpdateOneWithoutServiceRequestNestedInputObjectSchema)
            .optional(),
        language: z
...
export const ServiceRequestUpdateWithoutExternalTransportationInputObjectSchema = Schema;
