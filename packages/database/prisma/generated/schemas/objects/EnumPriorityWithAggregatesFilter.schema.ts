...
import { NestedEnumPriorityWithAggregatesFilterObjectSchema } from './NestedEnumPriorityWithAggregatesFilter.schema';
import { NestedIntFilterObjectSchema } from './NestedIntFilter.schema';
import { NestedEnumPriorityFilterObjectSchema } from './NestedEnumPriorityFilter.schema';

import type { Prisma } from '../../../../.prisma/client';

const Schema: z.ZodType<Prisma.EnumPriorityWithAggregatesFilter> = z
    .object({
...
export const EnumPriorityWithAggregatesFilterObjectSchema = Schema;
