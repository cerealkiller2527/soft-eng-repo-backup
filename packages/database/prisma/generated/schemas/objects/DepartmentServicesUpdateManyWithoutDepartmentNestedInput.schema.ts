...
const Schema: z.ZodType<Prisma.DepartmentServicesUpdateManyWithoutDepartmentNestedInput> = z
    .object({
        create: z
            .union([
...
export const DepartmentServicesUpdateManyWithoutDepartmentNestedInputObjectSchema = Schema;
