...
const Schema: z.ZodType<Prisma.EquipmentDeliveryUpdateWithoutServiceRequestInput> = z
    .object({
        deadline: z
...
export const EquipmentDeliveryUpdateWithoutServiceRequestInputObjectSchema = Schema;
