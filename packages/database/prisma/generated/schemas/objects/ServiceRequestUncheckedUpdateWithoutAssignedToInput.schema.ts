...
const Schema: z.ZodType<Prisma.ServiceRequestUncheckedUpdateWithoutAssignedToInput> = z
    .object({
        id: z
...
export const ServiceRequestUncheckedUpdateWithoutAssignedToInputObjectSchema = Schema;
