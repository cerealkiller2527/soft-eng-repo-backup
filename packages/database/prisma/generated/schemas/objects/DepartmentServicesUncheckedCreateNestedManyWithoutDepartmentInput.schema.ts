...
const Schema: z.ZodType<Prisma.DepartmentServicesUncheckedCreateNestedManyWithoutDepartmentInput> =
    z
        .object({
            create: z
                .union([
...
export const DepartmentServicesUncheckedCreateNestedManyWithoutDepartmentInputObjectSchema = Schema;
