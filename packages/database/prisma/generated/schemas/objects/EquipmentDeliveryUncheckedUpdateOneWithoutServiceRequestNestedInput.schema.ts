...
const Schema: z.ZodType<Prisma.EquipmentDeliveryUncheckedUpdateOneWithoutServiceRequestNestedInput> =
    z
        .object({
            create: z
                .union([
...
export const EquipmentDeliveryUncheckedUpdateOneWithoutServiceRequestNestedInputObjectSchema =
    Schema;
