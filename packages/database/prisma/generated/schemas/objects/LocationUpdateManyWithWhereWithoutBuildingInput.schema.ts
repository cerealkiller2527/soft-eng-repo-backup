...
const Schema: z.ZodType<Prisma.LocationUpdateManyWithWhereWithoutBuildingInput> = z
    .object({
...
export const LocationUpdateManyWithWhereWithoutBuildingInputObjectSchema = Schema;
