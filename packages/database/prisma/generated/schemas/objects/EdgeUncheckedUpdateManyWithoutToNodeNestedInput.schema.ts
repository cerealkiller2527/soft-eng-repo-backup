...
const Schema: z.ZodType<Prisma.EdgeUncheckedUpdateManyWithoutToNodeNestedInput> = z
    .object({
        create: z
            .union([
...
export const EdgeUncheckedUpdateManyWithoutToNodeNestedInputObjectSchema = Schema;
