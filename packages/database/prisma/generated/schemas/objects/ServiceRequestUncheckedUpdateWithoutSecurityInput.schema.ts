...
const Schema: z.ZodType<Prisma.ServiceRequestUncheckedUpdateWithoutSecurityInput> = z
    .object({
        id: z
...
export const ServiceRequestUncheckedUpdateWithoutSecurityInputObjectSchema = Schema;
