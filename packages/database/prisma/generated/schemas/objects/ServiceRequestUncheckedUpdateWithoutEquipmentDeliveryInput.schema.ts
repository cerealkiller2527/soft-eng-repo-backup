...
const Schema: z.ZodType<Prisma.ServiceRequestUncheckedUpdateWithoutEquipmentDeliveryInput> = z
    .object({
        id: z
...
export const ServiceRequestUncheckedUpdateWithoutEquipmentDeliveryInputObjectSchema = Schema;
