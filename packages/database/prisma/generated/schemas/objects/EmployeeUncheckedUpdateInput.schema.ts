...
import { ServiceRequestUncheckedUpdateManyWithoutAssignedToNestedInputObjectSchema } from './ServiceRequestUncheckedUpdateManyWithoutAssignedToNestedInput.schema';
...
const Schema: z.ZodType<Prisma.EmployeeUncheckedUpdateInput> = z
    .object({
        ...
        language: z
            ...
            .optional(),
        ServiceRequest: z
            .lazy(() => ServiceRequestUncheckedUpdateManyWithoutAssignedToNestedInputObjectSchema)
            .optional(),
    })
    .strict();
