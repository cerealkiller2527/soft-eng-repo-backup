...
const Schema: z.ZodType<Prisma.ServiceRequestUncheckedUpdateManyWithoutAssignedToNestedInput> = z
    .object({
        create: z
            .union([
...
export const ServiceRequestUncheckedUpdateManyWithoutAssignedToNestedInputObjectSchema = Schema;
