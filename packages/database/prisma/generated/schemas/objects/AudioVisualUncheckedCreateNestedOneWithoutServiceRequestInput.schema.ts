...
const Schema: z.ZodType<Prisma.AudioVisualUncheckedCreateNestedOneWithoutServiceRequestInput> = z
    .object({
        create: z
            .union([
...
export const AudioVisualUncheckedCreateNestedOneWithoutServiceRequestInputObjectSchema = Schema;
