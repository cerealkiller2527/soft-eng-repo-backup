...
const Schema: z.ZodType<Prisma.ServiceRequestUncheckedCreateNestedManyWithoutAssignedToInput> = z
    .object({
        create: z
            .union([
...
export const ServiceRequestUncheckedCreateNestedManyWithoutAssignedToInputObjectSchema = Schema;
