...
const Schema: z.ZodType<Prisma.LocationCreateNestedManyWithoutBuildingInput> = z
    .object({
        create: z
            .union([
...
export const LocationCreateNestedManyWithoutBuildingInputObjectSchema = Schema;
