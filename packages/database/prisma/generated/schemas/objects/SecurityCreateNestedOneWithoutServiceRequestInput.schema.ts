...
const Schema: z.ZodType<Prisma.SecurityCreateNestedOneWithoutServiceRequestInput> = z
    .object({
        create: z
            .union([
...
export const SecurityCreateNestedOneWithoutServiceRequestInputObjectSchema = Schema;
