...
const Schema: z.ZodType<Prisma.EquipmentDeliveryCreateWithoutServiceRequestInput> = z
    .object({
...
export const EquipmentDeliveryCreateWithoutServiceRequestInputObjectSchema = Schema;
