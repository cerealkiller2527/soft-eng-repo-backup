...
const Schema: z.ZodType<Prisma.DepartmentServicesUpdateManyWithoutServiceNestedInput> = z
    .object({
        create: z
            .union([
...
export const DepartmentServicesUpdateManyWithoutServiceNestedInputObjectSchema = Schema;
