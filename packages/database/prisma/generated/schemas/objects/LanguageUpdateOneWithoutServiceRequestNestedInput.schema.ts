...
const Schema: z.ZodType<Prisma.LanguageUpdateOneWithoutServiceRequestNestedInput> = z
    .object({
        create: z
            .union([
...
export const LanguageUpdateOneWithoutServiceRequestNestedInputObjectSchema = Schema;
