...
const Schema: z.ZodType<Prisma.ServiceRequestUncheckedUpdateWithoutExternalTransportationInput> = z
    .object({
        id: z
...
export const ServiceRequestUncheckedUpdateWithoutExternalTransportationInputObjectSchema = Schema;
