...
const Schema: z.ZodType<Prisma.LocationUncheckedUpdateManyWithoutBuildingNestedInput> = z
    .object({
        create: z
            .union([
...
export const LocationUncheckedUpdateManyWithoutBuildingNestedInputObjectSchema = Schema;
