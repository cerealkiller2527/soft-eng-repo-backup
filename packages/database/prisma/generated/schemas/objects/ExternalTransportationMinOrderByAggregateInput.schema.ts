...
const Schema: z.ZodType<Prisma.ExternalTransportationMinOrderByAggregateInput> = z
    .object({
...
export const ExternalTransportationMinOrderByAggregateInputObjectSchema = Schema;
