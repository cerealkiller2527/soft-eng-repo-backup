...
const Schema: z.ZodType<Prisma.LocationUpdateManyWithWhereWithoutDepartmentInput> = z
    .object({
...
export const LocationUpdateManyWithWhereWithoutDepartmentInputObjectSchema = Schema;
