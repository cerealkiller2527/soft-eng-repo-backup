...
const Schema: z.ZodType<Prisma.LanguageCreateNestedOneWithoutServiceRequestInput> = z
    .object({
        create: z
            .union([
...
export const LanguageCreateNestedOneWithoutServiceRequestInputObjectSchema = Schema;
