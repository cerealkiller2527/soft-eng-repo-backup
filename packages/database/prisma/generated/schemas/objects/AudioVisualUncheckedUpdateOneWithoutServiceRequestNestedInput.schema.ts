...
const Schema: z.ZodType<Prisma.AudioVisualUncheckedUpdateOneWithoutServiceRequestNestedInput> = z
    .object({
        create: z
            .union([
...
export const AudioVisualUncheckedUpdateOneWithoutServiceRequestNestedInputObjectSchema = Schema;
