...
const Schema: z.ZodType<Prisma.ServiceRequestUpdateWithoutAudioVisualInput> = z
    .object({
        type: z
            .union([
...
export const ServiceRequestUpdateWithoutAudioVisualInputObjectSchema = Schema;
