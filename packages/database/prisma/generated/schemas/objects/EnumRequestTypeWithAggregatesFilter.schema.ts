...
import { NestedEnumRequestTypeWithAggregatesFilterObjectSchema } from './NestedEnumRequestTypeWithAggregatesFilter.schema';
import { NestedIntFilterObjectSchema } from './NestedIntFilter.schema';
import { NestedEnumRequestTypeFilterObjectSchema } from './NestedEnumRequestTypeFilter.schema';

import type { Prisma } from '../../../../.prisma/client';

const Schema: z.ZodType<Prisma.EnumRequestTypeWithAggregatesFilter> = z
    .object({
...
export const EnumRequestTypeWithAggregatesFilterObjectSchema = Schema;
