...
const Schema: z.ZodType<Prisma.SecurityUpdateOneWithoutServiceRequestNestedInput> = z
    .object({
        create: z
            .union([
...
export const SecurityUpdateOneWithoutServiceRequestNestedInputObjectSchema = Schema;
