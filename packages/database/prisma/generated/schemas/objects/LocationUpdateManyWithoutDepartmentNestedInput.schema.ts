...
const Schema: z.ZodType<Prisma.LocationUpdateManyWithoutDepartmentNestedInput> = z
    .object({
        create: z
            .union([
...
export const LocationUpdateManyWithoutDepartmentNestedInputObjectSchema = Schema;
