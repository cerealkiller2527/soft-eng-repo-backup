...
async function main() {
    ...
    const chestnutNodes = [
        ...
        {
            suite: '0',
            description: '1right entrance outside',
            lat: 450,
            long: 315,
            floor: 1,
            type: 'Location',
        ...
        {
            suite: '0',
            description: 'Placeholder Node 1 (Suite 204B)',
            lat: -1,
            long: -1,
            floor: 1,
            type: 'Intermediary',
        ...
        {
            suite: '0',
            description: 'Placeholder Node 2 (Suite 317 Pharmacy)',
            lat: -1,
            long: -1,
            floor: 1,
            type: 'Intermediary',
        ...
        {
            suite: '0',
            description: 'Placeholder Node 3 (Suite 560)',
            lat: -1,
            long: -1,
            floor: 1,
            type: 'Intermediary',
        ...
        {
            suite: '0',
            description: 'Placeholder Node 4 (Suite 102B)',
            lat: -1,
            long: -1,
            floor: 1,
            type: 'Intermediary',
        ...
        {
            suite: '0',
            description: 'Placeholder Node 5 (Suite 200)',
            lat: -1,
            long: -1,
            floor: 1,
            type: 'Intermediary',
    ...
    const pat20Floor1Nodes = [
        ...
        {
            suite: '0',
            description: '1left entrance outside',
            lat: 42.0925,
            long: -71.266366,
            floor: 1,
            type: 'Location',
        ...
        {
            suite: '0',
            description: '1urology/cardiology',
            lat: 42.09272,
            long: -71.265919,
            floor: 1,
            type: 'Location',
    ...
    const pat22TempFloor1Nodes = [
        ...
        {
            suite: '0',
            description: '120/122parking entrance 1',
            lat: 42.092481,
            long: -71.266441,
            floor: 1,
            type: 'Intermediary',
        ...
        {
            suite: '0',
            description: '120/122parking entrance 2',
            lat: 42.092439,
            long: -71.266355,
            floor: 1,
            type: 'Intermediary',
    ...
    const rawDepartmentData = [
        ...
        },
        {
            ...
            description:
                "Cardiology, dermatology, endocrinology, gastroenterology, hematology, infectious diseases, mental health, general neurology, nutrition, primary care, pulmonary, sleep medicine, women's health",
        ...
        },
        {
            ...
            description:
                'Orthopedic surgery, vascular surgery, dermatology, pain medicine, travel medicine',
        ...
        },
        {
            ...
            description:
                'Acupuncture, health coaching, chiropractic, integrative medicine, massage therapy, neurology, echocardiography, pulmonary',
        ...
        },
        {
            ...
            description:
                'Orthopedic, sports, neurologic and vestibular Physical Therapy, pelvic floor therapy, occupational therapy, speech language pathology',
    ...
    function descToI(description: string) {
        ...
        console.error(
            'error seeding node paths, searched for node with description that does not exist: |' +
                description +
                '| does not exist'
        );
        return -1;
